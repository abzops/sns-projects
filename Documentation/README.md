...
- **Current Canonical Migration**: `20260817111751_p1_02d_process_instance_provenance_schema_parity.sql`
- **Package 1 Status**: `VERIFIED` (Production Parity + Real Local PostgreSQL E2E 34-Test Lifecycle Suite)
