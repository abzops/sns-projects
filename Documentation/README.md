...
| | `P6-03` Expense Ledger & Correction / Void Administration | **`IMPLEMENTED / MANUAL ACCEPTANCE PENDING`** | [P6-03 Spec](06_Implementation_Packages/Package_06_Finance_Frontend/P6-03_Expense_Ledger_and_Administration.md) · Route `/finance/expenses` · Correction, Void, Hard Delete & Audit Tombstones · All 36 assertions passed |
