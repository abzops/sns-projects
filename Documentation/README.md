...
- **Current Canonical Migration**: `20260817123556_p2_02_process_instance_movement_cancellation.sql`
- **Package 1 Status**: `VERIFIED` (Production Parity + Real Local PostgreSQL E2E 34-Test Lifecycle Suite + Trigger Security Closure)
- **Package 2 Status**: `P2-01, P2-01A, P2-02 VERIFIED` (Phase Rename + Phase Grant Hardening + Process Movement, Cancellation, Authorization & Audit)
