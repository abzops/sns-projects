...
| **Package 5** | `P5-03` | Subtask Completion, Expense Capture & Parent Closure Convergence | **`IMPLEMENTED / MANUAL ACCEPTANCE PENDING`** | [P5-03 Spec](../06_Implementation_Packages/Package_05_Expense_Execution/P5-03_Subtask_Completion_Expense_Parent_Closure.md) · Migration tip `20260820082034` (P5-03B ACL hotfix) · All suites passed |
...
- **P5-03 (`IMPLEMENTED / MANUAL ACCEPTANCE PENDING`)**: Subtask Completion, Expense Capture & Parent Closure Convergence. Integrates `public.subtasks` into 3-component task closure model, atomic `complete_subtask_with_expense` RPC, server-side status mutation guards, parent-subtask bidirectional sync (reopen to In Progress, auto-complete to Done), and ledger expense traceability (`subtask_id` with `ON DELETE RESTRICT`). P5-03B ACL hotfix restores `authenticated` EXECUTE grant on `private.complete_subtask_with_expense_internal`. Migrations `20260820072145`, `20260820073423` (P5-03A), `20260820082034` (P5-03B). All 35 test assertions passed. [P5-03 Spec](../06_Implementation_Packages/Package_05_Expense_Execution/P5-03_Subtask_Completion_Expense_Parent_Closure.md).
- **Package 5 Status**: **`EXTENDED / MANUAL ACCEPTANCE PENDING`** (P5-01..C VERIFIED · P5-02..C VERIFIED · P5-03 IMPLEMENTED / MANUAL ACCEPTANCE PENDING).
