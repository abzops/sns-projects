...
| **Package 5** | `P5-03` | Subtask Completion, Expense Capture & Parent Closure Convergence | **`VERIFIED`** | [P5-03 Spec](../06_Implementation_Packages/Package_05_Expense_Execution/P5-03_Subtask_Completion_Expense_Parent_Closure.md) · Migration tip `20260820073423` (P5-03A) · All suites passed |
...
- **P5-03 (`VERIFIED`)**: Subtask Completion, Expense Capture & Parent Closure Convergence. Integrates `public.subtasks` into 3-component task closure model, atomic `complete_subtask_with_expense` RPC, server-side status mutation guards, parent-subtask bidirectional sync (reopen to In Progress, auto-complete to Done), and ledger expense traceability (`subtask_id` with `ON DELETE RESTRICT`). Migrations `20260820072145` and `20260820073423` (P5-03A). [P5-03 Spec](../06_Implementation_Packages/Package_05_Expense_Execution/P5-03_Subtask_Completion_Expense_Parent_Closure.md).
