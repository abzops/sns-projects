...
--
-- OV1-A operational visibility closure (canonical post-dump delta)
...
-- OV1-A Project ownership/bootstrap hotfix (canonical post-dump delta)
-- Project ownership is direct operational involvement. Existing System Role
-- and scoped descendant-involvement policies remain unchanged.
BEGIN;
