-- Migration: 20260819190058_p5_01c_parent_completion_ownership_closure.sql
-- Description: P5-01C: Final Parent Completion Ownership Closure.
--              Restores single parent auto-completion ownership to canonical P2-03 trigger
--              (trg_tasks_parent_completion_reevaluate) by removing redundant manual parent call
--              from private.complete_task_with_expense_internal.
...
COMMENT ON FUNCTION private.complete_task_with_expense_internal(uuid, jsonb, text) IS
  'P5-01C: Atomic ordinary task completion with optional expense capture, delegating parent auto-completion solely to canonical P2-03 trigger architecture.';
